    ...
    questions: [
      {
        ...
        a: "When you pay for a service, your payment is processed securely via Paystack. StudEx charges a flat ₦215.56 service fee and the vendor receives their full listing price directly via Paystack transfer.",
      },
      {
