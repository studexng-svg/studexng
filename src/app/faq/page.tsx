    ...
    questions: [
      {
        ...
        a: "When you pay for a service, your payment is processed securely via Paystack and held in escrow until you confirm you're satisfied — no hidden charges on top of what you see at checkout. The vendor receives their full listing price directly via Paystack transfer.",
      },
      {
