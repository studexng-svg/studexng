...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className="bg-[#FFF8F0] dark:bg-gray-950"
    >
      <head>
        <meta charSet="utf-8" />
        ...
        <meta
          name="description"
          content="Nigeria's #1 campus marketplace. Book lashes, nails, laundry, food and more from verified student vendors at Pan-Atlantic University. Fast, safe, and affordable."
        />
        <meta
          name="keywords"
