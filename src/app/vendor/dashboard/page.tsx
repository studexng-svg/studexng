...
type Tab = "messages" | "bookings" | "earnings" | "listings" | "orders" | "reviews" | "feedback";
...
function MessagesTab() {
  ...
  // Conversations list (mobile default + desktop sidebar)
  return (
      ...
      <div className="bg-white border border-stone-200 rounded-2xl p-5 shadow-sm">
        ...
        <div className="space-y-2 text-sm text-stone-500 leading-relaxed">
          ...
          <div className="flex items-start gap-3 bg-stone-50 border border-stone-100 rounded-xl p-3">
            ...
            <p>StudEx collects an <span className="text-stone-800 font-semibold">8% service fee</span> (min ₦50, max ₦3,500) from the buyer — this covers the platform and Paystack's processing cost. Your full listing price is transferred to your bank.</p>
          </div>
          <div className="flex items-start gap-3 bg-stone-50 border border-stone-100 rounded-xl p-3">
    ...
    return (
      <div className="pb-4">
        <div className="mb-5">
          ...
          <h2 className="font-black text-stone-900 text-xl tracking-tight" style={{ fontFamily: "var(--font-jakarta), 'Plus Jakarta Sans', sans-serif" }}>Platform Feedback</h2>
        </div>
  ...
  return (
    <div className="pb-4">
      ...
      <div className="bg-white border border-stone-200 rounded-2xl p-5 shadow-sm space-y-4">
        <div>
          <h3 className="text-lg font-black text-stone-900 tracking-tight" style={{ fontFamily: "var(--font-jakarta), 'Plus Jakarta Sans', sans-serif" }}>
