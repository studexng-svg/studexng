...
import {
  ...
  ChevronDown, ChevronRight, Home, Truck, MapPin, CalendarClock,
} from "lucide-react";
...
const NAV: {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Batch Templates",     href: "/admin/batch-templates",  icon: CalendarClock },
      { label: "Delivery Batches",    href: "/admin/delivery-batches", icon: Truck },
