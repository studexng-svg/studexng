...
class PaymentTransaction(models.Model):
    ...
    service_charge: 8% of listing price (covers platform margin + Paystack processing fee), minimum ₦50, maximum ₦3,000.
    ...
    # 8% service charge (min ₦50, max ₦3,000) — set explicitly on every new record
