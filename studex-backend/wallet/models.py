...
class Wallet(models.Model):
    ...
    Actual payments and payouts are handled by Paystack."""
...
class WalletTransaction(models.Model):
    ...
    # Payment reference (from Paystack or bank transfer)
...
# Paystack handles split payments and vendor payouts directly.
...
# Paystack subaccount code. Kept here only to avoid breaking migrations.
# ────────────────────────────────────────────────────────────────────────────
class BankAccount(models.Model):
    ...
    # Legacy field — no longer used. Paystack subaccount is in payments.SellerBankAccount
